...
//Class which deals with the user's data, CSV data, and Reports data structures
class StatsDataController: ObservableObject {
    ...
    //Order the array of userdata by date, for ease
    ...
    //Convert an array of userdata into reports format
    ...
    //Gets the reports for today's date
    ...
    //Gets the reports which have occured in the current month
    ...
    //Gets the reports which have occured in the current week
    ...
    //Gets the reports which have occured in the current year
    ...
    //When a new time period is selected, filter the reports by this new selected period
    ...
    //Fiters the data to do with the current user's predicted carbon usage
...
//If multiple reports occur within the same day, make them into one report
...
//Check whether there are reports which need to be merged, because they occur in the same day
...
//Remove a subset of reports from the larger reports array 
